...
<body>
<center>
<form name="editinfo-form" method="post" action="../Controller/sign-up-controller.php" novalidate onsubmit="return validateSignUp(this);">
<h1>Sign Up</h1>
<br><br><br>
Fullname
<input type="text" name="fullname" size="50px">
<?php if (!empty($fullnameMsg)) echo "<br><br>" . $fullnameMsg?>
<br><p id="fullnameError"></p><br>
Phone
<input type="text" name="phone" size="50px">
<?php if (!empty($phoneMsg)) echo "<br><br>" . $phoneMsg?>
<br><p id="phoneError"></p><br>
Email
<input type="email" name="email" size="50px">
<?php if (!empty($emailMsg)) echo "<br><br>" . $emailMsg?>
<br><p id="emailError"></p><br>
Address
<input type="text" name="address" size="50px">
<?php if (!empty($addressMsg)) echo "<br><br>" . $addressMsg?>
<br><p id="addressError"></p><br>
Date Of Birth &nbsp;&nbsp;&nbsp;
<input type="date" name="dob" size="50px">
<?php if (!empty($dobMsg)) echo "<br><br>" . $dobMsg?>
<br><p id="dobError"></p><br>
Religion &nbsp;&nbsp;&nbsp;
...
<?php if (!empty($religionMsg)) echo "<br><br>" . $religionMsg?>
<br><br>
Username
<input type="text" name="username" size="50px">
<?php if (!empty($usernameMsg)) echo "<br><br>" . $usernameMsg?>
<br><p id="usernameError"></p><br>
Password
<input type="password" name="password" size="50px">
<?php if (!empty($passwordMsg)) echo "<br><br>" . $passwordMsg?>
<br><p id="passwordError"></p><br>
Confirm Password
<input type="password" name="cpassword" size="50px">
<?php if (!empty($cpasswordMsg)) echo "<br><br>" . $cpasswordMsg?>
<br><p id="cpasswordError"></p><br>
