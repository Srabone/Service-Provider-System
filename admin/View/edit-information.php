...
<head>
    ...
    <link rel="stylesheet" href="CSS/style.css">
     ...
     <body>
                <form name="editinfo-form"method="post" action="../Controller/edit-information-controller.php" novalidate autocomplete="off">
                    <h1 name="editinfo-h1">Edit Information</h1>
                    Fullname
